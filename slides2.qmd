...
Run the code to make the choropleth maps. Change the variance in the data and re-plot, to see that nothing changes. 
...
::: {.column}
Here is the code that was used to make the cartogram from earlier in the session. Using the standard error provided in `toy_temp_mean`, can you make a `ggdibbler` version of this plot?
