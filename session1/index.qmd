...
These same approaches apply to many other types of displays.
...
1. Reinforce signal that are important
2. Hide signal that are primarily noise
...
Accessibility considerations are harder, because there is more information provided, e.g.
