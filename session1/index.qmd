...
- There can be multiple leves of uncertainty:
...
- Uncertainty is not just another variable, but some measures might be handled this way graphically. 
- Some measure might be encoded in the data as an extra column, e.g. standard error, IQR. This can be used in the plot to incorporate uncertainty.
...
forecast plots, and ask what is the version of uncertainty applied, confidence bands vs multiple samples
...
- Use the **lineup protocol** to determine is a reader can *detect the structured plot from not structured null plots*.
