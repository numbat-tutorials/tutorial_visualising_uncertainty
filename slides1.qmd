...
🐨 **[Harriet](https://harrietmason.netlify.app/)** is a *final year PhD student*, working on better representation of uncertainty in data visualisations, particularly focused on spatial data. <br>
...
1. understand what uncertainty means, in particular in relation to data visualisation.
2. be able to plot represent uncertainty on different types of plots. 
3. assess whether one representation may be better than another, based on cognitive perception principles and visual testing.
4. apply these new approaches for showing uncertainty in spatial data visualisation.
...
# Showing uncertainty {.transition-slide  .center-align}
...
1. Decide the appropriate information about the uncertainty to include in the display.
...
![](images/task-position-common-scale-1.png){width=120px}
![](images/task-position-non-aligned-scale-1.png){width=120px}
![](images/task-angle-1.png){width=120px}

![](images/task-area-1.png){width=120px}
![](images/task-color-chroma-1.png){width=120px}
...
pa1 <- ggplot(data=df, aes(x, y, shape=cl)) + 
  geom_point(size=3, alpha=0.8) +
  theme(legend.position="None", aspect.ratio=1,
        axis.text = element_blank(), 
        axis.title = element_blank())
pa2 <- ggplot(data=df, aes(x, y, colour=cl)) + 
  geom_point(size=3, alpha=0.8) +
  scale_color_discrete_divergingx(palette="Zissou 1") +
  theme(legend.position="None", aspect.ratio=1,
        axis.text = element_blank(), 
        axis.title = element_blank())
pa1 + pa2 + plot_layout(ncol=2)
```
...
![](images/which-ruler.png)
[Source: [http://dx.doi.org/10.4172/2153-0602.1000139](http://dx.doi.org/10.4172/2153-0602.1000139)]{.f50}
...
<!-- Need to have a gene expression example with rationale here and to emphasize "compared to what" -->

# Common measures and representations {.transition-slide}
...
<br><br>
[Source: [https://doi.org/10.1109/TVCG.2012.230](https://ieeexplore.ieee.org/document/6327249)]{.f50}


:::
::: {.column}

![](images/compare-designs.png)
